    ...
    <>
      <div>
          ...
          <div className="flex flex-col  md:flex-row gap-5">
            <div className="md:w-full md:mb-0 mb-8 flex flex-col gap-4">
              <div className=" text-primary-midnightBlue font-extrabold md:text-4xl text-2xl">
                <span className="text-primary-orange">Leadership </span>
                Development
              </div>
        ...
        <div className="container mx-auto 2xl:px-32 px-8 ">
          <div>
            <div className="flex flex-col gap-2 xl:my-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 px-2 md:p-6">
                {cardData.map((card, index) => (
                  ...
                  >
                    ...
                    <CardContent className="p-6 flex flex-col h-full">
                      ...
                      <CardDescription className="text-sm text-muted-foreground flex-grow text-justify">
                        {card.description}
                      </CardDescription>
                    </CardContent>
                  </Card>
