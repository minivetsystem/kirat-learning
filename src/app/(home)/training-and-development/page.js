...
const sections = [
  ...
  },
  {
    title: "Sanity Check",
    description:
      "With the help of this quick process of reviewing, Kirat ensures that our portfolios are reasonable and logical. It helps to rectify any of our potential flaws, inconsistencies, or unrealistic expectations early on. This process serves as a safeguard to prevent costly mistakes and ensures that the direction taken is sound before investing our significant time or resources.",
        ...
        <div className="flex flex-col  md:flex-row gap-5">
          <div className="md:w-full md:mb-0 mb-5 flex flex-col gap-4">
            <div className=" text-primary-midnightBlue font-extrabold md:text-4xl text-2xl">
              <span className="text-primary-orange">Training </span> &
              Development
            </div>
        ...
        <div>
          <div className="flex flex-col gap-8 py-5">
            <div className="md:w-full ">
              <h3 className="font-semibold md:text-4xl text-2xl mb-2">
                <span className="text-primary-orange">The </span>
                Process Highlight
              </h3>
            </div>

            <div className="space-y-12 p-0 md:p-5">
