      ...
      <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
        <div className="flex gap-2 flex-col w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0">
          <div className="pt-6 w-full m-auto flex items-center justify-center text-2xl font-semibold text-primary-midnightBlue">
            <img
              src="/kirat learning logo_color.jpg"
          ...
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form className="space-y-4 md:space-y-6" onSubmit={onLogin}>
              ...
              <div>
                <label
                  htmlFor="password"
                  className="block mb-2 text-sm font-medium text-primary-midnightBlue"
                >
                  Password
                </label>
                <input
              ...
              <button
                type="submit"
                className="w-full text-white bg-primary-blue hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center"
              >
